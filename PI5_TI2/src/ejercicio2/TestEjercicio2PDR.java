...
//				DatosEjercicio2.iniDatos("ficheros/Ejercicio2DatosEntrada3.txt");
				...
				PDR<Ejercicio2Vertex, Ejercicio2Edges,Ejercicio2Solucion> pdr=PDR.of(graph,null,null,null,true);
				Optional<GraphPath<Ejercicio2Vertex, Ejercicio2Edges>> camino= pdr.search();
				...
				GraphColors.toDot(pdr.outGraph(), "ficherosGrafos/Ejercicio2_1_H_PDR.gv",
...
//				GraphColors.toDot(pdr.outGraph(), "ficherosGrafos/Ejercicio2_2_H_PDR.gv",
//						v->String.format("(%s,%s,%s,%s)", v.indice().toString(),v.categoriasPorCubir().toString(),v.presupuestoRestante().toString(),v.acumValoracion().toString()),
//						e-> e.action().toString(),
//						v-> GraphColors.colorIf(Color.red, Ejercicio2Vertex.goal().test(v)),
//						e-> GraphColors.colorIf(Color.red, pdr.optimalPath.getEdgeList().contains(e)));
//				
//				GraphColors.toDot(pdr.outGraph(), "ficherosGrafos/Ejercicio2_3_H_PDR.gv",
//						v->String.format("(%s,%s,%s,%s)", v.indice().toString(),v.categoriasPorCubir().toString(),v.presupuestoRestante().toString(),v.acumValoracion().toString()),
//						e-> e.action().toString(),
//						v-> GraphColors.colorIf(Color.red, Ejercicio2Vertex.goal().test(v)),
//						e-> GraphColors.colorIf(Color.red, pdr.optimalPath.getEdgeList().contains(e)));
				...
				PDR<Ejercicio2Vertex, Ejercicio2Edges,Ejercicio2Solucion> pdr2=
						PDR.of(graph2,Ejercicio2Vertex::getSolucion,null,null,true);
				
				if(rr.isSolution(r)) {
					pdr2=PDR.of(graph2,Ejercicio2Vertex::getSolucion,r.getWeight(),r,true);
				}
				
				PDR<Ejercicio2Vertex, Ejercicio2Edges,Ejercicio2Solucion> pdr2f=
						PDR.of(graph2,Ejercicio2Vertex::getSolucion,null,null,true);
				
				Optional<GraphPath<Ejercicio2Vertex, Ejercicio2Edges>> camino2= pdr2f.search();
				...
				GraphColors.toDot(pdr2f.outGraph(), "ficherosGrafos/Ejercicio2_1_H&G_PDR.gv",
				v->String.format("(%s,%s,%s,%s)", v.indice().toString(),v.categoriasPorCubir().toString(),v.presupuestoRestante().toString(),v.acumValoracion().toString()),
				e-> e.action().toString(),
				v-> GraphColors.colorIf(Color.red, Ejercicio2Vertex.goal().test(v)),
				e-> GraphColors.colorIf(Color.red, pdr2f.optimalPath.getEdgeList().contains(e)));
				
//				GraphColors.toDot(pdr2f.outGraph(), "ficherosGrafos/Ejercicio2_2_H&G_PDR.gv",
//				v->String.format("(%s,%s,%s,%s)", v.indice().toString(),v.categoriasPorCubir().toString(),v.presupuestoRestante().toString(),v.acumValoracion().toString()),
//				e-> e.action().toString(),
//				v-> GraphColors.colorIf(Color.red, Ejercicio2Vertex.goal().test(v)),
//				e-> GraphColors.colorIf(Color.red, pdr2f.optimalPath.getEdgeList().contains(e)));
//				
//				GraphColors.toDot(pdr2f.outGraph(), "ficherosGrafos/Ejercicio2_3_H&G_PDR.gv",
//				v->String.format("(%s,%s,%s,%s)", v.indice().toString(),v.categoriasPorCubir().toString(),v.presupuestoRestante().toString(),v.acumValoracion().toString()),
//				e-> e.action().toString(),
//				v-> GraphColors.colorIf(Color.red, Ejercicio2Vertex.goal().test(v)),
//				e-> GraphColors.colorIf(Color.red, pdr2f.optimalPath.getEdgeList().contains(e)));
