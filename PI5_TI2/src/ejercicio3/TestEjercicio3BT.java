...
//		DatosEjercicio3.iniDatos("ficheros/Ejercicio3DatosEntrada3.txt");
		...
		BT <Ejercicio3Vertex, Ejercicio3Edges,Ejercicio3Solucion> bt=BT.of(graph,null,null,null,true);
		
		Optional<GraphPath<Ejercicio3Vertex, Ejercicio3Edges>> camino= bt.search();
...
//		System.out.println(camino.get());
		...
		GraphColors.toDot(bt.outGraph(), "ficherosGrafos/Ejercicio3_1_H_BT.gv",
...
//		GraphColors.toDot(bt.outGraph(), "ficherosGrafos/Ejercicio3_2_H_BT.gv",
//				v->String.format("(%s,%s,%s)", v.z().toString(),v.unidadesRestantes().toString(),v.demandasRestantes().toString()),
//				e-> e.action().toString(),
//				v-> GraphColors.colorIf(Color.red, Ejercicio3Vertex.goal().test(v)),
//				e-> GraphColors.colorIf(Color.red, bt.optimalPath.getEdgeList().contains(e)));
//		
//		GraphColors.toDot(bt.outGraph(), "ficherosGrafos/Ejercicio3_3_H_BT.gv",
//				v->String.format("(%s,%s,%s)", v.z().toString(),v.unidadesRestantes().toString(),v.demandasRestantes().toString()),
//				e-> e.action().toString(),
//				v-> GraphColors.colorIf(Color.red, Ejercicio3Vertex.goal().test(v)),
//				e-> GraphColors.colorIf(Color.red, bt.optimalPath.getEdgeList().contains(e)));
